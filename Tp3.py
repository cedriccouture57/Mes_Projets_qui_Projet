...
while play_game:
    ...
    if choix_jeux == 1:
      ...
      print(f"\nLe combat se fait avec un lancer de dé (simulé par un nombre aléatoire entre 1 et 6)\n"
            ...
            f"Si le dé du joueur donne 4 ou moins, il y a défaite : le niveau de vie tombe alors à 16 (20 - 4).\n"
            f"Si le dé du joueur donne 5 ou plus, il y a victoire : le niveau de vie monte alors à 24 (20 + 4).\n")
